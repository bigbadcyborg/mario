...
int main(int argc, char ** argv)
{
    ...
    int a;
    infile.open("assets/marioStill.txt");
    if(!infile)
        cout << "Error";
    infile.ignore(100, '\n');
    ...
    infile.open("assets/marioJump.txt");
    if(!infile)
        cout << "Error";
    infile.ignore(100, '\n');
    for (int col = 0; col < mario.getWidth(); col++){
    ...
    infile.open("assets/enemyPixel.txt");
    if(!infile)
        cout << "Error";
    infile.ignore(100, '\n');
    ...
    int coinPixel[40][40];
    infile.open("assets/coinToken.txt");
    infile.ignore(100, '\n');
    ...
    ifstream scoreBoard;
    scoreBoard.open("assets/scoreBoard.txt");
    if(!scoreBoard)
        cout << "ERROR";
    int scoreDig;
    ...
    infile.open("assets/powBlock.txt");
    if(!infile){
        cout << "ERROR";
    }
    infile.ignore(100, '\n');
